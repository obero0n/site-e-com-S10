          ...
          <article class="col-lg-6 my-4">
            <div class="card">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Prix : <?php echo $result["price"] ?></li>
                <li class="list-group-item">Lieu de production: <?php echo $result["made_in"] ?></li>
                <li class="list-group-item">Catégorie : <?php echo $result["category"] ?></li>
              </ul>
              <div class="card-body">
                <a href="<?php echo 'single.php?id=' . $result['id']; ?>" class="btn lightBg">Voir</a>
              </div>
            </div>
          </article>
          <?php
